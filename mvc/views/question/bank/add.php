            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post" id="question_bank" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="hints" placeholder="<?=$this->lang->line("question_bank_hints")?>" name="hints" value="<?=set_value('hints')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="mark" placeholder="<?=$this->lang->line("question_bank_mark")?>" name="mark" value="<?=set_value('mark')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
