        ...
        <div class="box outheBoxShadow wizard" data-initialize="wizard" id="questionWizard">
            <div class="box-header bg-white">
                <div class="checkbox hints">
                    <label>
<!--                        <span>Hints &nbsp;</span>-->
<!--                        <input class="" value="hints" name="hints" type="checkbox"> &nbsp;-->
                    </label>
...
<!--                </button>-->
<!--                <button class="btn oe-btn-answered btn-prev" type="button" name="" id="btnWizardPrev" disabled="disabled">-->
<!--                    <i class="fa fa-angle-left"></i> Previous-->
<!--                </button>-->
<!--                <button type="button" class="btn btn-primary btn-next" data-last="Finish">Next<span class="glyphicon glyphicon-arrow-right"></span></button>-->
<!--            </div>-->
...
//        $('#questionWizard').wizard();
    $('#reviewbutton').on('click', function () {
//        $('#question'+data.step).removeClass('notvisited');
//        $('#question'+data.step).removeClass('marked');
//        $('#question'+data.step).removeClass('answered');
//        $('#question'+data.step).addClass('notanswered');
        marked = 1;
...
//        $('#questionWizard').wizard('previous');
//    });
...
//            $('#question'+data.step).removeClass('');
//            $('#question'+data.step).addClass('');
...
//        console.log(data.step, NowStep);
//        console.log(marked, data.step);
...
//            }
    ...
    function jumpQuestion(questionNumber) {
        changeColor(NowStep);
//        console.log(NowStep, questionNumber);
...
//        console.log(hours, minutes, seconds, duration);
