                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="info-box">
                            ...
                            <p>
                                <span><?=$this->lang->line('online_exam_percentage')?> : </span>
                                <?=$onlineExam->percentage ? $onlineExam->percentage : ''?>
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                <?=isset($instruction) ? $instruction->title : ''?>
                            </p>
                            <p>
                                <span><?=$this->lang->line('online_exam_class')?> : </span>
                                <?=isset($class) ? $class->classes : ''?>
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                <?=isset($studentGroup) ? $studentGroup->group : ''?>
                            </p>
                            <p>
                                <span><?=$this->lang->line('online_exam_subject')?> : </span>
                                <?=isset($subject) ? $subject->subject : ''?>
                            </p>
                        </div>
                    </div>
                </div>
