            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="name" name="name" value="<?=set_value('name')?>" placeholder="<?=$this->lang->line("online_exam_name")?>">
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="duration" name="duration" value="<?=set_value('duration')?>" placeholder="<?=$this->lang->line("online_exam_duration")?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="startdate" name="startdate" value="<?=set_value('startdate')?>" placeholder="<?=$this->lang->line("online_exam_startdatetime")?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="enddate" name="enddate" value="<?=set_value('enddate')?>" placeholder="<?=$this->lang->line("online_exam_enddatetime")?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="startdatetime" name="startdatetime" value="<?=set_value('startdatetime')?>" placeholder="<?=$this->lang->line("online_exam_startdatetime")?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="enddatetime" name="enddatetime" value="<?=set_value('enddatetime')?>" placeholder="<?=$this->lang->line("online_exam_enddatetime")?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="negativeMark" name="negativeMark" value="<?=set_value('negativeMark')?>" placeholder="<?=$this->lang->line("online_exam_negativeMark")?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="random" name="random" value="<?=set_value('random')?>" placeholder="<?=$this->lang->line("online_exam_random_placeholder")?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="percentage" name="percentage" value="<?=set_value('percentage')?>" placeholder="<?=$this->lang->line("online_exam_percentage")?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="validDays" name="validDays" value="<?=set_value('validDays')?>" placeholder="<?=$this->lang->line("online_exam_validDays")?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="cost" name="cost" value="<?=set_value('cost')?>" placeholder="<?=$this->lang->line("online_exam_cost")?>">
                        </div>
                        <span class="col-sm-4 control-label">
